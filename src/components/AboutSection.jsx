...
import developerImg from "./img/download.png"; // ✅ Correct image import
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="flex justify-center items-center">
            <div className="relative max-w-sm">
              <img
                ref={imageRef}
                src={developerImg} // ✅ Correct usage
                alt="Developer"
          ...
          <div className="flex flex-col gap-6">
            <ComicPanel delay={0.2} className="rotated-panel">
              ...
              <p className="text-white">
                Like Peter Parker juggling his dual life, I balance the technical worlds of AWS, DevOps and Frontend Development. With a passion for creating seamless digital experiences, I swing between optimizing infrastructure and crafting beautiful user interfaces.
              </p>
            </ComicPanel>
